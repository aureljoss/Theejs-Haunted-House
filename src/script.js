...
import { bumpMap, metalness, normalMap } from 'three/examples/jsm/nodes/Nodes.js'
...
const wallColorTexture= textureLoader.load('./wall/red_bricks_02_1k/red_bricks_02_diff_1k.jpg')
const wallARMTexture= textureLoader.load('./wall/red_bricks_02_1k/red_bricks_02_arm_1k.jpg')
const wallNormalTexture= textureLoader.load('./wall/red_bricks_02_1k/red_bricks_02_nor_gl_1k.jpg')
...
const roofBumpTexture= textureLoader.load('./roof/roof_07_1k/roof_07_bump_1k.jpg')
...
roofBumpTexture.repeat.set(3,1)
...
//Grave
const graveColorTexture= textureLoader.load('./grave/white_plaster_rough_02_1k/white_plaster_rough_02_diff_1k.jpg')
const graveARMTexture= textureLoader.load('./grave/white_plaster_rough_02_1k/white_plaster_rough_02_arm_1k.jpg')
const graveNormalTexture= textureLoader.load('./grave/white_plaster_rough_02_1k/white_plaster_rough_02_nor_gl_1k.jpg')
...
const tick = () =>
{
    ...
    ghost1.position.y = Math.sin(ghost2Angle) * Math.sin(ghost1Angle * 2.34) * Math.sin(ghost1Angle * 3.45)
